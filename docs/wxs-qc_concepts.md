...
WxS-QC consists of four main analysis stages: data loading, sample QC, variant QC, and genotype QC.
...
The data-loading stage converts raw VCFs to Hail data structures and validates them against the provided external metadata:
...
This stage generally follows the approach described in
...
The Variant QC stage uses the approach used for gnomAD v2 (Karczewski et al. 2020) and the first stages of gnomAD v3.
...
Historically, this stage was designed for “classic” variant callers, which require recalibrating the call correctness.
...
The final stage, hard filter evaluation and genotype QC, is a new functionality developed at WSI.
The detailed description of this stage is available in the pipeline documentation and in the paper (Koko et al. 2024).
At this stage,
we test
