...
- [ ] Relevant scripts/helpers/config/tests were inspected before editing
- [ ] No task/codebase conflict was resolved silently
- [ ] Environment blockers were reported rather than worked around
